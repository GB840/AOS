...
| 7 个大脑子模块 (task_classifier 等) | 2237 | **自研编排(决策)** |
| **合计** | **~3627** (注:570/400/420 为旧 brain.py:1841 时代分段估算,brain.py 现 1965 行,分段数仅近似) | |
...
**净效果:2237 行 → 约 0~200 行(只留"终审交付"服务 + L1-L5→capability 映射表)。**
