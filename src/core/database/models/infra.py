...
class Thread(TimestampMixin, table=True):
    ...
    title: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
...
class Message(TimestampMixin, table=True):
    ...
    tool_calls: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
...
class Checkpoint(TimestampMixin, table=True):
    ...
    parent_checkpoint_id: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
