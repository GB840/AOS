...
class Skill(TimestampMixin, table=True):
    ...
    entry: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
...
class SkillVersion(TimestampMixin, table=True):
    ...
    changelog: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
    artifact_path: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
...
class McpConnector(TimestampMixin, table=True):
    ...
    endpoint: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
...
class AgentCard(TimestampMixin, table=True):
    ...
    model_draft: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
    model_final: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
...
class SubagentRegistry(TimestampMixin, table=True):
    ...
    id: int | None = Field(default=None, primary_key=True)
    agent_id: str = Field(sa_column=sa.Column(sa.Text, sa.ForeignKey("agents.agent_id"), index=True))
    display_name: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
...
class KnowledgeGraphNode(TimestampMixin, table=True):
    ...
    type: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
...
class KnowledgeGraphEdge(TimestampMixin, table=True):
    ...
    relation: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
...
class CapabilityRegistry(TimestampMixin, table=True):
    ...
    name: str = Field(sa_column=sa.Column(sa.Text, unique=True, index=True))
    description: str | None = Field(default=None, sa_column=sa.Column(sa.Text))
    owner_agent_id: str | None = Field(default=None, sa_column=sa.Column(sa.Text, sa.ForeignKey("agents.agent_id")))
