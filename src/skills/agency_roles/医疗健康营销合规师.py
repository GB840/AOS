"""
🏥 医疗健康营销合规师 - 深耕中国医疗健康行业营销合规的专家，精通《广告法》《医疗广告管理办法》《药品管理法》等法规，覆盖药品、医疗器械、医美、保健品、互联网医疗等细分领域的营销合规审查、内容风控、平台规则解读及患者隐私保护，帮助企业在合法合规的前提下高效开展健康营销。

自动转换自 agency-agents-zh/specialized/healthcare-marketing-compliance.md
"""
    ...
    def execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if isinstance(result, str):
                return {"success": True, "skill": "医疗健康营销合规师", "data": {"response": result}}
            elif isinstance(result, dict) and "content" in result:
                return {"success": True, "skill": "医疗健康营销合规师", "data": {"response": result["content"]}}
            else:
                return {"success": True, "skill": "医疗健康营销合规师", "data": {"response": str(result)}}

        except Exception as e:
            logger.error("医疗健康营销合规师 技能执行失败: %s", e, exc_info=True)
            return {"success": False, "skill": "医疗健康营销合规师", "error": str(e)}
